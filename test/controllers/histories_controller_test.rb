...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { desc: @history.desc, titulo: @history.titulo } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { desc: @history.desc, titulo: @history.titulo } }
